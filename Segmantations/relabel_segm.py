...
def main():
    ...
    # Crea un volume di output inizialmente tutto a 0 perchè per lo sweep di imfusion tutto il resto deve essere 0
    new_data = np.zeros(orig.shape, dtype=np.int16)
