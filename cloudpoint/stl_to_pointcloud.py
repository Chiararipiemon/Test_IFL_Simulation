...
#This script converts the patient's surface STL mesh exported from 3D Slicer into a point cloud and estimates an outward-pointing surface normal for each point. Currently set to sample 8,000 points.
# Modify the paths at the end of the code
