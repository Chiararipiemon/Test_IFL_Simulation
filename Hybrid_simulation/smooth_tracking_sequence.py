# SMOOTH_TRACKING_SEQUENCE: questo codice legge il CSV ricavato da Moveit!, lo abbassa di 94 mm in direzione Y (questa registrazione è stata calcolata a mano) e fa un moving average sulle posizioni per rendere più smooth la traiettoria
# nella console Python di Imfusion:
exec("""
